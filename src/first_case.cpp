...
int main() {
    ...
    graph->edge_array[0].cost = 5;

    graph->edge_array[1].source = 0;
    graph->edge_array[1].destination = 2;
    graph->edge_array[1].cost = 3;

    graph->edge_array[2].source = 0;
    graph->edge_array[2].destination = 3;
    graph->edge_array[2].cost = 1;

    graph->edge_array[3].source = 1;
    graph->edge_array[3].destination = 4;
    graph->edge_array[3].cost = 2;
    
    graph->edge_array[4].source = 2;
    graph->edge_array[4].destination = 6;
    graph->edge_array[4].cost = 2;

    graph->edge_array[5].source = 3;
    graph->edge_array[5].destination = 5;
    graph->edge_array[5].cost = -1;

    graph->edge_array[6].source = 5; 
    graph->edge_array[6].destination = 6;
    graph->edge_array[6].cost = 1;


    graph->edge_array[7].source = 4;
    graph->edge_array[7].destination = 6;
    graph->edge_array[7].cost = -2;

    graph->edge_array[8].source = 6; 
    graph->edge_array[8].destination = 7; 
    graph->edge_array[8].cost = 6;
